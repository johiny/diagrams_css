...
<Mark backgroundColor={'greenBlue'}left={'50%'} top={'15%'} >
...
<Mark backgroundColor={'lightBlue'} left={'6%'} top={'35%'}  paddingX={'1.5%'} textColor={'darkBlue'}>
Comité de Auditoria
</Mark>
<Mark backgroundColor={'lightBlue'}left={'25%'} paddingY={'1.5%'} top={'35%'} paddingX={'1.5%'}textColor={'darkBlue'}>
Comité de Crédito
</Mark>
<Mark backgroundColor={'lightBlue'}left={'60%'} top={'35%'} textColor={'darkBlue'}>
Comité de Gestión <br/> de Riesgos
</Mark>
<Mark backgroundColor={'lightBlue'}left={'78%'} top={'35%'} textColor={'darkBlue'}>
Comité de <br/> Cumplimiento
</Mark>
<Mark backgroundColor={'lightBlue'}left={'94%'} top={'35%'} width={'9%'} paddingX={'1%'} textColor={'darkBlue'}>
...
<Mark backgroundColor={'white'}left={'18%'} top={'50%'} paddingX={'1.5%'} textColor={'darkBlue'}>
Comité de Auditoría
</Mark>
<Mark backgroundColor={'white'}left={'32%'} top={'50%'} paddingX={'1.5%'} textColor={'darkBlue'}>
Comité de Auditoría
</Mark>
<Mark backgroundColor={'greenBlue'}left={'50%'} top={'63%'} paddingX={'1.5%'} paddingY={'1.5%'} textColor={'white'}>
Gerencia General
</Mark>
...
<Mark backgroundColor={'white'}left={'10%'} top={'79%'} paddingX={'1.5%'} paddingY={'1.5%'} textColor={'darkBlue'}>
Comité de Ética
</Mark>
<Mark backgroundColor={'white'}left={'29%'} top={'79%'} paddingX={'1.5%'} textColor={'darkBlue'}>
Comité de Gerentes
</Mark>
<Mark backgroundColor={'white'}left={'50%'} top={'79%'} paddingX={'1.5%'} textColor={'darkBlue'}>
Comité de Tecnologia
</Mark>
<Mark backgroundColor={'white'}left={'68%'} top={'79%'} width={'9%'} textColor={'darkBlue'}>
Comité de Continuidad <br/> del Negocio
</Mark>
<Mark backgroundColor={'white'}left={'90%'} top={'79%'} width={'9%'} textColor={'darkBlue'}>
